...
4. Create a [data source](/kendo-ui/api/wrappers/php/Kendo/Data/DataSource) and set its [data](/kendo-ui/api/wrappers/php/Kendo/Data/DataSource#data) and [schema](/kendo-ui/api/wrappers/php/Kendo/Data/DataSource#schema). Setting the schema is required
...
5. Create a [listview](/kendo-ui/api/wrappers/php/Kendo/UI/ListView), configure its [template](/kendo-ui/api/wrappers/php/Kendo/UI/ListView#template) and set its [data source](/kendo-ui/api/wrappers/php/Kendo/UI/ListView#datasource).
        ...
        ?>
6. Output the listview by echo-ing the result of the [render](/kendo-ui/api/wrappers/php/Kendo/UI/Widget#render) method.
