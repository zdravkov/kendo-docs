---
title: Local binding
meta_title: How to bind Kendo DropDownList for PHP to PHP array
meta_description: Learn how to bind Kendo UI DropDownList for PHP to array of data
slug: php-dropdownlist-local-binding
publish: true
