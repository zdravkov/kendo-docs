...
The MobilePopOver HtmlHelper extension is a server-side wrapper for the [Kendo UI Mobile PopOver](/kendo-ui/api/mobile/popover) widget. It allows you to configure the Kendo UI Mobile PopOver
...
Then you can use you can use the JavaScript [API](/kendo-ui/api/mobile/popover#methods) of the popover.
...
You can subscribe to all [events](/kendo-ui/api/mobile/popover#events) exposed by the widget:
