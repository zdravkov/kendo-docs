...
description: How to use Telerik UI  for ASP.NET in ASP.NET MVC 3 applications
---
...
![Final result](/getting-started/using-kendo-with/aspnet-mvc/images/mvc3-final.png)
