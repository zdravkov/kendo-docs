...
In order to see those features in action please check the [agaptive rendering demos](http://demos.telerik.com/kendo-ui/grid/adaptive).
...
![](/getting-started/web/grid/adaptive-resizing-icon.png)
