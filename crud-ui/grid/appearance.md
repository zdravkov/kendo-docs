...
position: 2
previous_url: /getting-started/web/grid/walkthrough
---
...
By default the Grid has no height and expands to fit all table rows. For historical reasons, the [Grid MVC wrapper](/getting-started/using-kendo-with/aspnet-mvc/helpers/grid/configuration#scrolling)
...
[`resize()`](/getting-started/using-kendo-with/using-kendo-in-responsive-web-pages#individual-widget-resizing) method. Alternatively, apply the desired height to the scrollable data area, instead of the Grid widget:
