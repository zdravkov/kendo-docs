---
title: Use AngularJS in Grid popup editor template
page_title: Use AngularJS in Grid popup editor template
description: Kendo Grid example that demontrates how to use AngularJS in Grid popup editor template.
---
