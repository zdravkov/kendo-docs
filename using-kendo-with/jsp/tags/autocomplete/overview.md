...
*   **ajax** - the autocomplete will make ajax requests to get the data. [Here](/using-kendo-with/jsp/tags/autocomplete/ajax-binding) you can find more information about this binding.
