...
*   **ajax** - the dropdownlist will make ajax request to get the data. [Here](/using-kendo-with/jsp/tags/dropdownlist/ajax-binding) you can find more information about this binding.
