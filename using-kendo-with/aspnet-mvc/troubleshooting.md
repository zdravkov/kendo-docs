...
unless [deferred initialization](/using-kendo-with/aspnet-mvc/introduction#deferring-kendo-ui-initialization-scripts) is used.
...
[Using Kendo UI MVC wrappers inside client templates](/using-kendo-with/aspnet-mvc/fundamentals#client-templates)
