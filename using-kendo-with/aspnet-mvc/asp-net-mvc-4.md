---
title: ASP.NET MVC 4
page_title: Using Kendo UI with ASP.NET MVC 4
...
**The Telerik UI for ASP.NET MVC Visual Studio extensions (http://docs.telerik.com/kendo-ui/using-kendo-with/aspnet-mvc/vs-integration/introduction) automate the whole procedure which this document describes.**
...
![New ASP.NET MVC 4 Application](/using-kendo-with/aspnet-mvc/images/mvc4-new-app.png)
...
![Kendo directories in Solution Explorer](/using-kendo-with/aspnet-mvc/images/mvc4-solution.png)
...
![Final result](/using-kendo-with/aspnet-mvc/images/mvc4-final.png)
