...
![kendo-commecrial-zip-layout](/using-kendo-with/aspnet-mvc/tutorial-kendo-music-store/music-store-web/images/kendo-commecrial-zip-layout.png)
...
![kendo-nuget](/using-kendo-with/aspnet-mvc/tutorial-kendo-music-store/music-store-web/images/kendo-nuget.png)
...
This will be discussed later in the tutorial, but it is because we later use some of [UI for ASP.NET MVC](http://docs.telerik.com/kendo-ui/using-kendo-with/aspnet-mvc/asp-net-mvc-4) which insert **&lt;script&gt;** tags into the **&lt;body&gt;** of the page, and require that jQuery already be defined.
