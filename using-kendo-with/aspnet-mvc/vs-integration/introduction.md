...
**No selected project in Visual Studio**
 ...
 ![Create Menu](/using-kendo-with/aspnet-mvc/vs-integration/images/create_menu.png)


**Selected project in Visual Studio is Standard ASP.NET MVC 3, 4 or 5 Web Application**

 ![Convert Menu](/using-kendo-with/aspnet-mvc/vs-integration/images/convert_menu.png)

**Selected project in Visual Studio is Telerik UI for ASP.NET MVC** Web Application

 ![Configure Menu](/using-kendo-with/aspnet-mvc/vs-integration/images/configure_menu.png)

When installed, the extensions add the following project templates to the New Project dialog of Visual Studio:

 ![Project templates](/using-kendo-with/aspnet-mvc/vs-integration/images/project_template.png)
...
![Mvc Wizard](/using-kendo-with/aspnet-mvc/vs-integration/images/mvc_wizard.png)
