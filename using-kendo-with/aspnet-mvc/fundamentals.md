...
![Server-side wrapper outputs HTML and JavaScript](/using-kendo-with/aspnet-mvc/images/wrapper-output.png)
...
![Kendo HtmlHelper extension method](/using-kendo-with/aspnet-mvc/images/kendo-extension.png)

### Widget options

The widget options are exposed via [fluent interface](http://en.wikipedia.org/wiki/Fluent_interface).

![Fluent interface](/using-kendo-with/aspnet-mvc/images/fluent-interface.png)
...
![Wrapper name](/using-kendo-with/aspnet-mvc/images/wrapper-name.png)
