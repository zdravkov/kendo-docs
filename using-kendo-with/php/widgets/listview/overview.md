...
* [local](/using-kendo-with/php/widgets/listview/local-binding) - the listview is bound to PHP array
* [remote](/using-kendo-with/php/widgets/listview/remote-binding) - the listview makes AJAX requests and is bound to JSON result
