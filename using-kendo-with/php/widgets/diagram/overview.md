...
You can populate a Kendo Diagram for PHP with [remote binding](/using-kendo-with/php/widgets/chart/remote-binding). The Diagram makes AJAX requests and is bound to JSON result
