...
* [local](/using-kendo-with/php/widgets/scheduler/local-binding) - the scheduler is bound to PHP array
* [remote](/using-kendo-with/php/widgets/scheduler/remote-binding) - the scheduler makes AJAX requests and is bound to JSON result
