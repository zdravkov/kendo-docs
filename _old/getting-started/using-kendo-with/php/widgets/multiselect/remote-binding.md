...
page_title: How to bind Kendo MultiSelect for PHP to remote service which returns JSON
description: Learn how to bind Kendo UI MultiSelect for PHP to JSON
---
# Remote Binding
