...
page_title: How to bind Kendo DropDownList for PHP to remote service which returns JSON
description: Learn how to bind Kendo UI DropDownList for PHP to JSON
---
# Remote Binding
