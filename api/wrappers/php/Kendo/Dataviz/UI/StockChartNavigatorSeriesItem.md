---
nav_title: StockChartNavigatorSeriesItem
---
...
#### Example - using [\Kendo\Dataviz\UI\StockChartNavigatorSeriesItemStack](/api/wrappers/php/Kendo/Dataviz/UI/StockChartNavigatorSeriesItemStack)
    <?php
    $seriesItem = new \Kendo\Dataviz\UI\StockChartNavigatorSeriesItem();
