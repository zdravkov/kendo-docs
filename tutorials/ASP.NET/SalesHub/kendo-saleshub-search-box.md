...
slug: kendo-saleshub-search-box
tags: Tutorial
publish: true
---
...
## Handling User Selection in the AutoComplete
...
## Setting up the Search Results Window and Grid
...
To do this we create a [Kendo Window](http://demos.kendoui.com/web/window/index.html) that contains a
[Kendo Grid](http://demos.kendoui.com/web/grid/index.html).
